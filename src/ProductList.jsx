...
import { addItem } from './CartSlice'; // Make sure CartSlice is correctly imported
        ...
        <div>
            <div className="navbar" style={{
                ...
                <div style={{
                    ...
                    <div> <a href="#" onClick={(e) => handleCartClick(e)} style={{ color: 'white', fontSize: '30px', textDecoration: 'none' }}>
                        <h1 className='cart'>
